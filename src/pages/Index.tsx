...
const Index = () => {
  ...
  const coreFeatures = [
    ...
    },
    {
      ...
      description:
        "Generate commercial invoices, certificates of origin, and packing lists automatically with one click.",
      color: "bg-gradient-to-br from-blue-500 to-purple-500",
    },
    {
      icon: DollarSign,
    ...
    },
    {
      ...
      description:
        "Automatically ensure compliance with international trade regulations and standards across 50+ countries.",
      color: "bg-gradient-to-br from-blue-500 to-purple-500",
    },
    {
      icon: Globe,
      ...
      description:
        "Real-time insights into trade regulations, tariffs, and market opportunities worldwide.",
      color: "bg-gradient-to-br from-blue-500 to-purple-500",
    },
  ];
  ...
  const platformBenefits = [
    {
      ...
      description:
        "Seamlessly sync your Shopify products and orders. No manual data entry required.",
    },
    {
      icon: Clock,
      title: "Time Savings",
      description:
        "Reduce compliance processing time by up to 80%. Focus on growing your business.",
    },
    {
      icon: TrendingUp,
      title: "Cost Optimization",
      description:
        "Accurate landed cost calculations help you price products competitively and maximize margins.",
    },
    {
      icon: Settings,
      title: "Automated Workflows",
      description:
        "Set up automated compliance checks and documentation generation for your entire product catalog.",
    },
  ];
            ...
            <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-600 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                  AI-powered enterprise platform for Shopify merchants. Automate
                  HS code classification, generate export documentation,
                  calculate landed costs, and ensure compliance across 50+
                  countries.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 sm:pt-4 justify-center lg:justify-start">
                ...
                <Link to="/business" className="w-full sm:w-auto">
                  <Button
                    variant="outline"
                    className="w-full sm:w-auto border-2 border-slate-300 text-slate-900 hover:bg-slate-50 hover:border-slate-400 px-6 sm:px-10 py-4 sm:py-6 text-base sm:text-lg font-semibold h-auto"
                  >
                    View Features
                  </Button>
                </Link>
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-colors flex items-center justify-center pointer-events-none z-20 rounded-lg">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white/90 rounded-full flex items-center justify-center shadow-xl opacity-0 group-hover:opacity-100 transition-opacity">
                    <Play
                      className="h-8 w-8 sm:h-10 sm:w-10 text-blue-600 ml-1"
                      fill="currentColor"
                    />
                  </div>
                </div>
                <CardContent className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:gap-4">
                    <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg p-3 sm:p-5 border border-blue-100">
                      <div className="text-xs font-semibold text-slate-600 uppercase tracking-wide mb-1 sm:mb-2">
                        Products Processed
                      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            ...
            <p className="text-base sm:text-lg text-slate-600 max-w-3xl mx-auto px-4">
              Connect your Shopify store and automate compliance in minutes. Our
              AI-powered platform handles everything from HS code classification
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12 lg:mb-16">
            ...
            <Card className="border-0 shadow-lg bg-white text-center">
              ...
              <CardContent>
                <CardDescription className="text-slate-600 leading-relaxed">
                  One-click integration syncs your products, orders, and
                  inventory. No manual data entry required.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg bg-white text-center">
              ...
              <CardContent>
                <CardDescription className="text-slate-600 leading-relaxed">
                  Our AI automatically detects HS codes with 95%+ accuracy and
                  ensures compliance across 50+ countries.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg bg-white text-center">
              ...
              <CardContent>
                <CardDescription className="text-slate-600 leading-relaxed">
                  Instantly generate invoices, certificates of origin, and
                  packing lists. Calculate landed costs in real-time.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm leading-relaxed">
                      AI-powered classification eliminates manual errors and
                      speeds up customs processing. Reduce classification time
                      by 80%.
                    </p>
                  </div>
                </div>
            ...
            <Card className="border-0 shadow-lg bg-white">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-slate-900 mb-2">
                      Save 320+ Hours Monthly
                    </h3>
                    <p className="text-slate-600 text-sm leading-relaxed">
                      Automate documentation generation and compliance checks.
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm leading-relaxed">
                      Real-time landed cost calculations and compliance rules
                      for major markets worldwide. Scale globally with
                      confidence.
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm leading-relaxed">
                      Comprehensive supply chain risk analysis helps you
                      identify and mitigate environmental and social compliance
                      issues.
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            ...
            <p className="text-base sm:text-lg text-slate-600 max-w-2xl mx-auto px-4">
              Built specifically for Shopify stores. Integrate seamlessly and
              start automating your global trade operations today.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {platformBenefits.map((benefit, index) => (
              <Card
                key={index}
                className="border-0 shadow-lg bg-white hover:shadow-xl hover:scale-105 transition-all duration-300"
              >
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-0 shadow-lg rounded-lg p-6 sm:p-8 lg:p-12">
            ...
            <p className="text-base sm:text-lg text-slate-600 mb-6 sm:mb-10 max-w-2xl mx-auto leading-relaxed">
              Join 500+ Shopify merchants already saving time and reducing
              compliance risk. Start your 14-day free trial today.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <Link to="/signup" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold px-6 sm:px-8 py-4 sm:py-6 h-auto text-sm sm:text-base shadow-md hover:shadow-lg transition-all"
                >
                  Start Free Trial
                </Button>
              </Link>
              <Link to="/contact" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full sm:w-auto border-2 border-slate-300 text-slate-900 hover:bg-white hover:border-slate-400 font-semibold px-6 sm:px-8 py-4 sm:py-6 h-auto text-sm sm:text-base"
                >
                  Contact Sales
                </Button>
              </Link>
