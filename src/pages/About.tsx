...
const About = () => {
  const values = [
    ...
    },
    {
      ...
      title: "Integrity",
      description:
        "We maintain the highest standards of integrity and transparency in all our business practices.",
    },
    {
      icon: Lightbulb,
      title: "Innovation",
      description:
        "We embrace innovation and cutting-edge technology to solve complex business challenges.",
    },
    {
      icon: Users,
      title: "Collaboration",
      description:
        "We believe in the power of collaboration and building strong partnerships with our clients.",
    },
  ];
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-slate-600 max-w-3xl mx-auto mb-6 sm:mb-10">
            We're building the future of global trade compliance. Our AI-powered
            platform helps Shopify merchants automate compliance, reduce errors,
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div>
              ...
              <p className="text-base sm:text-lg text-slate-600 mb-4 sm:mb-6 leading-relaxed">
                To simplify global trade compliance for Shopify merchants
                worldwide. We believe that every business, regardless of size,
                should have access to enterprise-grade compliance tools that
                enable seamless international expansion.
              </p>
              <p className="text-base sm:text-lg text-slate-600 leading-relaxed">
                Through AI-powered automation and real-time analytics, we're
                eliminating the barriers that prevent businesses from scaling
                globally. Our platform handles the complexity so you can focus
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-slate-700 font-medium">
                      Manual HS code classification is time-consuming and
                      error-prone
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-slate-700 font-medium">
                      Export documentation generation is repetitive and tedious
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-slate-700 font-medium">
                      Landed cost calculations are complex and vary by country
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-slate-700 font-medium">
                      Compliance requirements change frequently across markets
                    </span>
                  </li>
                </ul>
              </CardContent>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 sm:p-8 lg:p-12">
            ...
            <p className="text-base sm:text-lg text-slate-600 mb-6 sm:mb-10 max-w-2xl mx-auto leading-relaxed">
              Be part of the future of global trade. Start automating your
