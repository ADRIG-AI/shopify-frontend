...
import { TrendingUp, Clock, Eye, Calendar, Filter } from "lucide-react";
  ...
  const insights = [
    {
      ...
      excerpt:
        "How artificial intelligence is revolutionizing HS code classification and customs processing for international commerce.",
    ...
    },
    {
      ...
      excerpt:
        "An in-depth analysis of emerging trends in global trade and how businesses can adapt to changing market conditions.",
      author: "Michael Chen",
    ...
    },
    {
      ...
      excerpt:
        "Why environmental, social, and governance reporting is becoming essential for international commerce and stakeholder trust.",
      author: "Emily Rodriguez",
      date: "January 10, 2025",
      readTime: "6 min read",
      category: "ESG",
      image:
        "https://images.unsplash.com/photo-1569163139394-de6e4d1b5b1e?w=500&h=300&fit=crop",
    },
    {
      title: "Data-Driven Decision Making in International Trade",
      excerpt:
        "Essential strategies for implementing data-driven decision making processes that drive global business growth and efficiency.",
      author: "David Kim",
      date: "January 8, 2025",
      readTime: "8 min read",
      category: "Strategy",
    ...
    },
    {
      ...
      excerpt:
        "How advanced analytics can help businesses identify and mitigate supply chain risks in an increasingly complex global market.",
      author: "Sarah Johnson",
      date: "January 5, 2025",
      readTime: "6 min read",
    ...
    },
    {
      ...
      excerpt:
        "Exploring how predictive analytics is transforming trade forecasting and enabling proactive compliance decision-making.",
      author: "Michael Chen",
      date: "January 3, 2025",
      readTime: "5 min read",
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-slate-600 max-w-3xl mx-auto mb-6 sm:mb-10">
            ...
            in global trade compliance and analytics.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {insights.map((insight, index) => (
              <Card
                key={index}
                className="border-0 shadow-lg bg-white hover:shadow-xl transition-shadow overflow-hidden"
              >
                ...
                <CardContent>
                  ...
                  <Button
                    variant="ghost"
                    className="w-full text-blue-600 hover:text-purple-600 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50"
                  >
                    Read More
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-white border border-slate-200 rounded-lg p-6 sm:p-8 lg:p-12">
            ...
            <p className="text-base sm:text-lg text-slate-600 mb-6 sm:mb-10 max-w-2xl mx-auto leading-relaxed">
              Start automating your compliance and analytics today with a 14-day
              free trial.
            </p>
